...
const AMPED_UP_COLLECTION: { [key: number]: any } = {
  11: {
    tokenId: "11",
    imageUrl: "017raituffUC.png",
    card: AMPED_UP_CARDS[1],
    rarity: PM_RARITY.U,
  },
  12: {
    tokenId: "12",
    imageUrl: "017raituffR.png",
    card: AMPED_UP_CARDS[1],
    rarity: PM_RARITY.R,
  },
  13: {
    tokenId: "13",
    imageUrl: "017raituffL.png",
    card: AMPED_UP_CARDS[1],
    rarity: PM_RARITY.L,
  },
  14: {
    tokenId: "14",
    imageUrl: "018dballsC.png",
    card: AMPED_UP_CARDS[2],
    rarity: PM_RARITY.C,
  },
  15: {
    tokenId: "15",
    imageUrl: "018dballsUC.png",
    card: AMPED_UP_CARDS[2],
    rarity: PM_RARITY.U,
  },
  16: {
    tokenId: "16",
    imageUrl: "019graffingUC.png",
    card: AMPED_UP_CARDS[3],
    rarity: PM_RARITY.U,
  },
  17: {
    tokenId: "17",
    imageUrl: "019graffingR.png",
    card: AMPED_UP_CARDS[3],
    rarity: PM_RARITY.R,
  },
  18: {
    tokenId: "18",
    imageUrl: "019graffingL.png",
    card: AMPED_UP_CARDS[3],
    rarity: PM_RARITY.L,
  },
  19: {
    tokenId: "19",
    imageUrl: "020astrohelmUC.png",
    card: AMPED_UP_CARDS[4],
    rarity: PM_RARITY.U,
  },
  20: {
    tokenId: "20",
    imageUrl: "020astrohelmR.png",
    card: AMPED_UP_CARDS[4],
    rarity: PM_RARITY.R,
  },
  21: {
    tokenId: "21",
    imageUrl: "021profcokeUC.png",
    card: AMPED_UP_CARDS[5],
    rarity: PM_RARITY.U,
  },
  22: {
    tokenId: "22",
    imageUrl: "021profcokeR.png",
    card: AMPED_UP_CARDS[5],
    rarity: PM_RARITY.R,
  },
  23: {
    tokenId: "23",
    imageUrl: "021profcokeL.png",
    card: AMPED_UP_CARDS[5],
    rarity: PM_RARITY.L,
  },
  24: {
    tokenId: "24",
    imageUrl: "022degenmntR.png",
    card: AMPED_UP_CARDS[6],
    rarity: PM_RARITY.R,
  },
  25: {
    tokenId: "25",
    imageUrl: "022degenmntL.png",
    card: AMPED_UP_CARDS[6],
    rarity: PM_RARITY.L,
  },
  26: {
    tokenId: "26",
    imageUrl: "023farmerC.png",
    card: AMPED_UP_CARDS[7],
    rarity: PM_RARITY.C,
  },
  27: {
    tokenId: "27",
    imageUrl: "023farmerUC.png",
    card: AMPED_UP_CARDS[7],
    rarity: PM_RARITY.U,
  },
  28: {
    tokenId: "28",
    imageUrl: "024ekrowC.png",
    card: AMPED_UP_CARDS[8],
    rarity: PM_RARITY.C,
  },
  29: {
    tokenId: "29",
    imageUrl: "024ekrowUC.png",
    card: AMPED_UP_CARDS[8],
    rarity: PM_RARITY.U,
  },
  30: {
    tokenId: "30",
    imageUrl: "024ekrowR.png",
    card: AMPED_UP_CARDS[8],
    rarity: PM_RARITY.R,
  },
  31: {
    tokenId: "31",
    imageUrl: "025artduckoUC.png",
    card: AMPED_UP_CARDS[9],
    rarity: PM_RARITY.U,
  },
  32: {
    tokenId: "32",
    imageUrl: "025artduckoR.png",
    card: AMPED_UP_CARDS[9],
    rarity: PM_RARITY.R,
  },
  33: {
    tokenId: "33",
    imageUrl: "025artduckoL.png",
    card: AMPED_UP_CARDS[9],
    rarity: PM_RARITY.L,
  },
  34: {
    tokenId: "34",
    imageUrl: "026mynxUC.png",
    card: AMPED_UP_CARDS[10],
    rarity: PM_RARITY.U,
  },
  35: {
    tokenId: "35",
    imageUrl: "026mynxR.png",
    card: AMPED_UP_CARDS[10],
    rarity: PM_RARITY.R,
  },
  36: {
    tokenId: "36",
    imageUrl: "027magikazamC.png",
    card: AMPED_UP_CARDS[11],
    rarity: PM_RARITY.C,
  },
  37: {
    tokenId: "37",
    imageUrl: "027magikazamUC.png",
    card: AMPED_UP_CARDS[11],
    rarity: PM_RARITY.U,
  },
  38: {
    tokenId: "38",
    imageUrl: "027magikazamR.png",
    card: AMPED_UP_CARDS[11],
    rarity: PM_RARITY.R,
  },
  39: {
    tokenId: "39",
    imageUrl: "028toxiqueML.png",
